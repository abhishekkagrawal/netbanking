    ...
    <s:form action="TransferPageAction">
        <div class="wrapper row4">
            <div id="quicknav" class="clear">
                <ul>
                    <li><a href="<s:url action="myAccountTransferPageAction"/>">My Account</a></li>                        
                    <li><a href="<s:url action="transferTransferPageAction"/>">Transfer</a></li>
                    <li><a href="<s:url action="billPaymentTransferPageAction"/>">Bill Payment</a></li>
                    <li><a href="<s:url action="cardDetailTransferPageAction"/>">Cards Details</a></li>
                    <li><a href="<s:url action="personalDetailTransferPageAction"/>">Personal Detail</a></li> 
                ...
                <tbody>
                    <tr class="tabledatatr3">
                        <td height="45" bgcolor="#faf6f5" align="left" style="border:1px solid #cfc5aa;border-collapse:collapse;">
                            <br/>
                            <b>
                                <a class="whiteText" href="<s:url action="neftTransferTransferPageAction"/>">
                                    <font color="#8c062f">NEFT</font>
                                </a>
                            </b>
                            <br/>
                            Transfer amount upto 2 Lacs to other bank's account  through NEFT
                            <br/>
                        </td>
                    </tr>
                </tbody>
